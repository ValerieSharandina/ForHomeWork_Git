...
## 17. Копирование внешного репозитория

Перед копированием внешнего репозитория, локальный репозиторий не должен быть инициализирован в папке с текущим проектом. 
...
Для продолжения работы в копированном репозитории, необходимо перейти в эту папку. Для этого используется команда:
