...
## 15 Работа с удаленными репозиториями
 ...
 Нужно отжать чек-бокс, который позволет копировать только ветку *main*.
...
Следующим этапом необходимо создать и перейти в новую ветку **нельзя продолжать работать в ветках main или master**

git checkout -b "имя ветки"

После выполнения и сохранения работы делаем коммит:

git commit -am "имя коммита"

## 15.5. Отправка данных на свой аккаунт репозитария
Отправка данных осуществлется коммандой 

*git push -u origin "имя ветки "*

## 15.6. Запрос на присоединение
В личном аккаунте репозитария необходимо нажать на повившуюся кнопку "Compare & pull request".

!["Compare & pull request"](pull_request.png)


Далее сделать комментарий и нажать кнопку "Create pull request".