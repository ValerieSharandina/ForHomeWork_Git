...
После того как мы скопировали на свой аккаунт чужой файл и скопировали ссылку на него, теперь нам необходимо перейти в VSCode и в командной строке ввести команду  *git clone* и вставить ссылку.
