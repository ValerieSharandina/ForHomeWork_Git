...
# PULL
Команда необходима для обновления существующего репозитория перетягивания обновлений.


# PUSH
Позволяет  перенести обновления в GitHub в ранее созданный репозиторий.

# PULL request
Это запрос на принятие изменений. То есть при нажатии кнопки с этой командой изменения видны у  ответственного за принятие/отклонение.
