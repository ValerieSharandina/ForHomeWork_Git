...
Теперь нашу копию клонируем на компьютер с помощью команды
...
![Редактирование файла на гитхабе](GB6.png)

Чтобы новые изменения поместить в локальный репозиторий, надо сохранить измения, а затем использовать команду git pull, тогда все наши строки, перенесутся в локальное хранилище.

* *git pull*

![Вытаскиваем значения](GB7.png)

После завершения всех изменений и загрузки файла в удаленный репозиторий в личном аккаунте, необходимо выполнить pull request. Это поможет владельцу репозитория увидеть ваши изменения и принять их.
