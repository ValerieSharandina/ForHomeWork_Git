...
При первом puch необходимо будет пройти авторизацию. Репозиторий появится на GitHub.
...
- Далее следовать описанию п.1 раздела "Работа в удаленном репозитории GitHub"
