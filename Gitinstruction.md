...
На GitHub можно работать в репозитории на своем аккаунте, обмениваться данными со своим локальным репозиторием или репозиториями коллег, копировать репозитории open sourse project.

1. Для копирования репозитория с GitHub на свой локальный, нужно нажать кнопку *Code* на странице этого репозитоия и скопировать *ссылку на репозиторий*.
...
Для дальнейших изменений неоходимо перейти в папку скопированного репозитория командой *cd folder_name*, создать новую ветку (*git  branch_name*) и работать в ней.

2. Для отправки репозитория на GitHub c локального, нужно в своем аккаунте на GitHub нажать на кнопку "+" и в выпадающем окне выбрать последующее действие (например, *new repositori* - создать новый репозиторий). 

В нем выбрать пункт *привязать репозиторий привязать к удаленному репозиторию*

GitHub выдаст подсказки, которые необходимо сделать в терминале VSCjde:

*git remote add origin ссылка*
*git branch main(master)* - вписать свой вариант
*git push -u origin main(master)*

При первом puch необходимо будет пройти авторизацию.

Репозиторий появится на GitHub.